...
public struct AIModelDescriptor: Codable, Sendable, Equatable {
    ...
    public init(id: String, connectionId: String, displayName: String, providerKind: AIProviderKind, enabled: Bool, discoveredAt: String) {
        self.id = id
...
public struct AIResponseRequest: Codable, Sendable, Equatable {
    ...
    public init(connectionId: String, model: String, systemPrompt: String? = nil, input: [AIInputItem], reasoningEffort: AIReasoningEffort? = nil, maxOutputTokens: Int? = nil, outputSchema: JSONValue? = nil, tools: [AIToolDefinition]? = nil, toolCalls: [AIToolCall]? = nil, toolResults: [AIToolResult]? = nil) {
        self.connectionId = connectionId
        self.model = model
...
public struct AIFileReference: Codable, Sendable, Equatable {
    ...
    public init(id: String, contentType: String, sizeBytes: Int, checksumSha256: String, expiresAt: String) {
        self.id = id
...
public struct AIResponse: Codable, Sendable, Equatable {
    ...
    public init(id: String, status: String, provider: AIProviderKind, model: String, text: String? = nil, structuredOutput: JSONValue? = nil, toolCalls: [AIToolCall]? = nil, usage: AIUsage, providerRequestId: String? = nil) {
        self.id = id
        self.status = status
