...
public struct ErrorResponse: Codable, Sendable, Equatable {
    ...
    public init(error: String, retryAfter: Int? = nil, captchaRequired: Bool? = nil, siteKey: String? = nil, lockedUntil: String? = nil) {
        self.error = error
...
public struct TwoFALoginRequest: Codable, Sendable, Equatable {
    ...
    public init(tempToken: String, code: String? = nil, recoveryCode: String? = nil, rememberDevice: Bool? = nil, deviceName: String? = nil) {
...
public struct TrustedDeviceResponse: Codable, Sendable, Equatable {
    ...
    public init(id: String, name: String, userAgent: String? = nil, ipAddress: String? = nil, lastUsedAt: String, expiresAt: String, createdAt: String) {
        self.id = id
        self.name = name
...
public struct SocialAccountResponse: Codable, Sendable, Equatable {
    ...
    public init(id: String, provider: String, providerUserId: String, email: String? = nil, name: String? = nil, firstName: String? = nil, lastName: String? = nil, profilePicture: String? = nil, username: String? = nil, locale: String? = nil, createdAt: String, updatedAt: String) {
        self.id = id
...
public struct UserResponse: Codable, Sendable, Equatable {
    ...
    public var updatedAt: String
    public var socialAccounts: [SocialAccountResponse]?
    public init(id: String, email: String, emailVerified: Bool, name: String? = nil, firstName: String? = nil, lastName: String? = nil, profilePicture: String? = nil, locale: String? = nil, twoFaEnabled: Bool, twoFaMethod: String? = nil, hasPassword: Bool, roles: [String]? = nil, createdAt: String, updatedAt: String, socialAccounts: [SocialAccountResponse]? = nil) {
        self.id = id
        self.email = email
...
public struct UpdateProfileRequest: Codable, Sendable, Equatable {
    ...
    public var profilePicture: String?
    public var locale: String?
    public init(name: String? = nil, firstName: String? = nil, lastName: String? = nil, profilePicture: String? = nil, locale: String? = nil) {
        self.name = name
        self.firstName = firstName
        self.lastName = lastName
        self.profilePicture = profilePicture
...
public struct AppLoginConfigResponse: Codable, Sendable, Equatable {
    ...
    public init(appId: String, enabledSocialProviders: [String], oidcEnabled: Bool, hasOidcClients: Bool, magicLinkEnabled: Bool, emailCodeLoginEnabled: Bool, passkeyLoginEnabled: Bool, twoFaEnabled: Bool, twoFaRequired: Bool, sms_2faEnabled: Bool, trustedDeviceEnabled: Bool, loginLogoUrl: String? = nil, loginPrimaryColor: String? = nil, loginSecondaryColor: String? = nil, loginDisplayName: String? = nil, oidcClientLoginTheme: String? = nil, pwMinLength: Int, pwMaxLength: Int, pwRequireUpper: Bool, pwRequireLower: Bool, pwRequireDigit: Bool, pwRequireSymbol: Bool) {
        self.appId = appId
...
public struct PasskeyResponse: Codable, Sendable, Equatable {
    ...
    public init(id: String, name: String, createdAt: String, lastUsedAt: String? = nil, backupEligible: Bool, backupState: Bool, transports: [String]) {
        self.id = id
        self.name = name
        self.createdAt = createdAt
        self.lastUsedAt = lastUsedAt
...
public struct SessionResponse: Codable, Sendable, Equatable {
    ...
    public init(id: String, ipAddress: String, userAgent: String, createdAt: String, lastActive: String, isCurrent: Bool) {
        self.id = id
        self.ipAddress = ipAddress
        self.userAgent = userAgent
        self.createdAt = createdAt
...
public struct ActivityLogResponse: Codable, Sendable, Equatable {
    ...
    public init(id: String, userId: String, eventType: String, timestamp: String, ipAddress: String, userAgent: String, details: JSONValue, isAnomaly: Bool, severity: String) {
        self.id = id
        self.userId = userId
...
public struct PaginationResponse: Codable, Sendable, Equatable {
    ...
    public init(page: Int, limit: Int, totalRecords: Int, totalPages: Int, hasNext: Bool, hasPrevious: Bool) {
        self.page = page
        self.limit = limit
