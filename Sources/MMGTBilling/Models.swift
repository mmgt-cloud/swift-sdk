...
public struct BillingOffer: Codable, Sendable, Equatable {
    ...
    public init(id: String, key: String, name: String, `description`: String, planType: String, billingModel: BillingModel, interval: BillingInterval, currency: String, unitAmountCents: Int, baseSeatCount: Int, extraSeatAmountCents: Int? = nil, contactUrl: String? = nil, metadata: [String: String]? = nil) {
        self.id = id
        self.key = key
        self.name = name
...
public struct BillingSubscriptionView: Codable, Sendable, Equatable {
    ...
    public init(scope: String, status: BillingStatus, offerId: String, offerKey: String, offerName: String, currentPeriodEnd: String? = nil, cancelAtPeriodEnd: Bool) {
        self.scope = scope
        self.status = status
...
public struct BillingEntitlement: Codable, Sendable, Equatable {
    ...
    public init(id: String, offerId: String, key: String, name: String, status: BillingStatus, stripeCheckoutSessionId: String, createdAt: String) {
        self.id = id
        self.offerId = offerId
        self.key = key
        self.name = name
...
public struct BillingWorkspaceSummary: Codable, Sendable, Equatable {
    ...
    public init(id: String, name: String, role: WorkspaceRole, status: BillingStatus, seatLimit: Int, memberCount: Int, availableSeats: Int, isOwner: Bool) {
        self.id = id
        self.name = name
        self.role = role
        self.status = status
...
public struct BillingAccessResponse: Codable, Sendable, Equatable {
    ...
    public init(appId: String, userId: String, hasPaidAccess: Bool, plan: BillingPlanType, status: BillingStatus, subscription: BillingSubscriptionView? = nil, personalSubscription: BillingSubscriptionView? = nil, workspace: BillingWorkspaceSummary? = nil, workspaceMemberships: [BillingWorkspaceSummary], entitlements: [BillingEntitlement], freeLimitBannerKey: String? = nil) {
        self.appId = appId
        self.userId = userId
...
public struct WorkspaceCheckoutRequest: Codable, Sendable, Equatable {
    ...
    public init(offerId: String, successUrl: String? = nil, cancelUrl: String? = nil, workspaceName: String, extraSeats: Int? = nil) {
        self.offerId = offerId
        self.successUrl = successUrl
        self.cancelUrl = cancelUrl
...
public struct CheckoutApiRequest: Codable, Sendable, Equatable {
    ...
    public var workspaceName: String?
    public var extraSeats: Int?
    public init(offerId: String, successUrl: String? = nil, cancelUrl: String? = nil, workspaceName: String? = nil, extraSeats: Int? = nil) {
        self.offerId = offerId
        self.successUrl = successUrl
        self.cancelUrl = cancelUrl
        self.workspaceName = workspaceName
...
public struct ChangeSubscriptionResponse: Codable, Sendable, Equatable {
    ...
    public var subscription: BillingSubscriptionView?
    public init(status: String, access: BillingAccessResponse, subscription: BillingSubscriptionView? = nil) {
        self.status = status
        self.access = access
        self.subscription = subscription
    }
...
public struct BillingWorkspace: Codable, Sendable, Equatable {
    ...
    public init(id: String, appId: String, name: String, ownerUserId: String, status: BillingStatus, seatLimit: Int, extraSeats: Int, createdAt: String, updatedAt: String) {
        self.id = id
        self.appId = appId
        self.name = name
...
public struct WorkspaceMember: Codable, Sendable, Equatable {
    ...
    public var status: BillingStatus
    public var createdAt: String
    public init(id: String, workspaceId: String, userId: String, email: String, role: WorkspaceRole, status: BillingStatus, createdAt: String) {
        self.id = id
        self.workspaceId = workspaceId
        self.userId = userId
        self.email = email
...
public struct WorkspaceInvite: Codable, Sendable, Equatable {
    ...
    public init(id: String, workspaceId: String, email: String, status: BillingStatus, expiresAt: String, invitedByUserId: String, createdAt: String, emailDeliveryStatus: String? = nil) {
        self.id = id
        self.workspaceId = workspaceId
        self.email = email
        self.status = status
...
public struct WorkspaceInviteWithLink: Codable, Sendable, Equatable {
    ...
    public init(id: String, workspaceId: String, email: String, status: BillingStatus, expiresAt: String, invitedByUserId: String, createdAt: String, emailDeliveryStatus: String? = nil, acceptUrl: String) {
        self.id = id
        self.workspaceId = workspaceId
        self.email = email
        self.status = status
