...
public struct ServiceConfiguration: Sendable, Hashable, Codable {
    ...
    public init(baseURL: URL, appID: String) throws {
        guard baseURL.scheme == "https", baseURL.host != nil,
              ...
              !appID.contains(where: { $0.isWhitespace || $0.isNewline }), !appID.contains("\0") else {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        try self.init(baseURL: values.decode(URL.self, forKey: .baseURL), appID: values.decode(String.self, forKey: .appID))
    }
    ...
    public func url(_ components: [String], query: [URLQueryItem] = []) throws -> URL {
        guard components.allSatisfy({ !$0.isEmpty && $0 != "." && $0 != ".." && !$0.contains("/") && !$0.contains("\\") && !$0.contains("\0") }) else {
