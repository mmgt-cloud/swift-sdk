...
public enum RealtimeChannels {
    ...
    public static func validate(_ channel: String) throws {
        ...
        guard !channel.isEmpty, channel.utf8.count <= 128, channel.unicodeScalars.allSatisfy(allowed.contains),
              !channel.split(separator:"/",omittingEmptySubsequences:false).contains(where:{$0.isEmpty || $0 == "." || $0 == ".."}) else {
