...
public struct SyncCollection: Codable, Sendable, Equatable {
    ...
    public init(key: String, displayName: String, mode: SyncCollectionMode, accessScope: SyncAccessScope, conflictPolicy: SyncConflictPolicy, schema: JSONValue, enabled: Bool, createdAt: String, updatedAt: String) {
        self.key = key
...
public struct SyncRecord: Codable, Sendable, Equatable {
    ...
    public var updatedAt: String?
    public init(collection: String, id: String, version: SyncVersion, data: JSONValue? = nil, deleted: Bool, workspaceId: String? = nil, updatedAt: String? = nil) {
...
public struct SyncMutation: Codable, Sendable, Equatable {
    ...
    public var workspaceId: String?
    public init(collection: String, recordId: String, op: SyncOperation, data: JSONValue? = nil, mutationId: String? = nil, baseVersion: SyncVersion? = nil, workspaceId: String? = nil) {
        self.collection = collection
...
public struct SyncMutationPayload: Codable, Sendable, Equatable {
    ...
    public var baseVersion: SyncVersion?
    public var workspaceId: String?
    public init(collection: String, recordId: String, op: SyncOperation, data: JSONValue? = nil, mutationId: String, baseVersion: SyncVersion? = nil, workspaceId: String? = nil) {
        self.collection = collection
        self.recordId = recordId
        self.op = op
        self.data = data
...
public struct SyncPushResult: Codable, Sendable, Equatable {
    ...
    public init(mutationId: String, collection: String, recordId: String, status: String, version: SyncVersion? = nil, conflictId: String? = nil, error: String? = nil) {
        self.mutationId = mutationId
        self.collection = collection
        self.recordId = recordId
        self.status = status
...
public struct SyncPullRequest: Codable, Sendable, Equatable {
    ...
    public init(clientId: String? = nil, cursor: String? = nil, limit: Int? = nil, collections: [String]? = nil, workspaceIds: [String]? = nil) {
        self.clientId = clientId
        self.cursor = cursor
        self.limit = limit
...
public struct SyncChange: Codable, Sendable, Equatable {
    ...
    public var createdAt: String
    public init(sequence: SyncVersion, collection: String, recordId: String, op: SyncOperation, version: SyncVersion, data: JSONValue? = nil, workspaceId: String? = nil, userId: String? = nil, createdAt: String) {
...
public struct SyncSnapshotRequest: Codable, Sendable, Equatable {
    ...
    public var limit: Int?
    public init(collections: [String]? = nil, workspaceIds: [String]? = nil, pageToken: String? = nil, limit: Int? = nil) {
        self.collections = collections
        self.workspaceIds = workspaceIds
...
public struct SyncSnapshotResponse: Codable, Sendable, Equatable {
    ...
    public init(records: [SyncChange], watermark: SyncVersion, nextPage: String? = nil, cursor: String? = nil, hasMore: Bool, expiresAt: String) {
...
public struct SyncConflict: Codable, Sendable, Equatable {
    ...
    public var status: String
    public var createdAt: String
    public init(id: String, collection: String, recordId: String, mutationId: String, clientId: String, userId: String, baseVersion: SyncVersion? = nil, currentVersion: SyncVersion, attemptedData: JSONValue? = nil, status: String, createdAt: String) {
        self.id = id
        self.collection = collection
        self.recordId = recordId
        self.mutationId = mutationId
